...
/*-----------------------------------------------
              @(target):= _m60f1d3e08103c5273af3d18ae4885fce.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__m60f1d3e08103c5273af3d18ae4885fce

#else
#  define SWIG_init    init_m60f1d3e08103c5273af3d18ae4885fce

#endif
#define SWIG_name    "_m60f1d3e08103c5273af3d18ae4885fce"
