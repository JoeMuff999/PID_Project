...
/*-----------------------------------------------
              @(target):= _m8c15403d0f0788188a0cd132ec8cd2e3.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__m8c15403d0f0788188a0cd132ec8cd2e3

#else
#  define SWIG_init    init_m8c15403d0f0788188a0cd132ec8cd2e3

#endif
#define SWIG_name    "_m8c15403d0f0788188a0cd132ec8cd2e3"
...
SWIGINTERN PyObject *_wrap_cannon_analytic(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cannon_analytic",&obj0)) SWIG_fail;
  {
    // CANNON *
    void * temp_ptr ;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"cannon_analytic", _wrap_cannon_analytic, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
