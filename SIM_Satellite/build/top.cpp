...
#define SWIGTYPE_p_RTSyncSimObject swig_types[32]
#define SWIGTYPE_p_SEND_ME swig_types[33]
#define SWIGTYPE_p_SIM_COMMAND swig_types[34]
#define SWIGTYPE_p_SIM_MODE swig_types[35]
#define SWIGTYPE_p_SatelliteSimObject swig_types[36]
...
#define SWIGTYPE_p_VS_WRITE_MODE swig_types[64]
#define SWIGTYPE_p_V_DATA swig_types[65]
#define SWIGTYPE_p_VariableServerSimObject swig_types[66]
#define SWIGTYPE_p_ZeroconfSimObject swig_types[67]
#define SWIGTYPE_p__DLLIST swig_types[68]
#define SWIGTYPE_p__DLLNODE swig_types[69]
#define SWIGTYPE_p__TrickErrorHndlr swig_types[70]
...
SWIGINTERN int Swig_var_dyn_set(PyObject *_val) {
  {
    void *argp = 0;
    int res = SWIG_ConvertPtr(_val, &argp, SWIGTYPE_p_SatelliteSimObject,  0  | 0);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""dyn""' of type '""SatelliteSimObject""'");
    }
    if (!argp) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""dyn""' of type '""SatelliteSimObject""'");
    } else {
      SatelliteSimObject * temp;
      temp  = reinterpret_cast< SatelliteSimObject * >(argp);
      dyn = *temp;
      if (SWIG_IsNewObj(res)) delete temp;
    }
  }
...
SWIGINTERN PyObject *Swig_var_dyn_get(void) {
  ...
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(&dyn), SWIGTYPE_p_SatelliteSimObject,  0 );
  return pyobj;
}
