...
/* Created 2019/01/27 14:22:27 joey $ */
#include "../S_source.hh"
...
int SatelliteSimObject::call_function ( Trick::JobData * curr_job ) {
    ...
    switch ( curr_job->id ) {
        case 0:
            satellite.satellite_default_data( &satellite) ;
            break ;
        case 1:
...
SimEnvironment::SimEnvironment() {
    ...
    local_env["TRICK_SYSTEM_CFLAGS"] = "-I/usr/local/trick_source -I/usr/local/include -I/usr/local/include/trick/compat -DTRICK_VER=17 -DTRICK_MINOR=5 -fpic  -DUSE_ER7_UTILS_INTEGRATORS -fexceptions ";
    setenv("TRICK_SYSTEM_CFLAGS", local_env["TRICK_SYSTEM_CFLAGS"].c_str(), 0);
    local_env["TRICK_SYSTEM_CXXFLAGS"] = "-I/usr/local/trick_source -I/usr/local/include -I/usr/local/include/trick/compat -DTRICK_VER=17 -DTRICK_MINOR=5 -fpic  -DUSE_ER7_UTILS_INTEGRATORS ";
    ...
    local_env["TRICK_USER_CSHRC"] = "/home/joey/.Trick_user_cshrc";
    setenv("TRICK_USER_CSHRC", local_env["TRICK_USER_CSHRC"].c_str(), 0);
    local_env["TRICK_USER_HOME"] = "/home/joey/trick_sims";
    ...
    local_env["TRICK_USER_PROFILE"] = "/home/joey/.Trick_user_profile";
...
void memory_init( void ) {
    ...
    ALLOC_INFO * ai ;
    exec_set_version_date_tag( "@(#)CP Version 17.5.dev, Sun Jan 27 14:22:27 2019" ) ;
    exec_set_build_date( "Sun Jan 27 14:22:27 2019" ) ;
