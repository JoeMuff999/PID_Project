...
/* Created 2019/01/24 00:02:28 root $ */
#include "../S_source.hh"
...
int SatelliteSimObject::call_function ( Trick::JobData * curr_job ) {
    ...
    switch ( curr_job->id ) {
        case 0:
            satellite_default_data( &satellite) ;
            break ;
        case 1:
            satellite_init( &satellite ) ;
            break ;
        case 2:
            satellite_analytic( &satellite ) ;
            break ;
        case 3:
            satellite_shutdown( &satellite ) ;
            break ;
        default:
            trick_ret = -1 ;
            break ;
...
void memory_init( void ) {
    ...
    ALLOC_INFO * ai ;
    exec_set_version_date_tag( "@(#)CP Version 17.4.dev, Thu Jan 24 00:02:28 2019" ) ;
    exec_set_build_date( "Thu Jan 24 00:02:28 2019" ) ;
