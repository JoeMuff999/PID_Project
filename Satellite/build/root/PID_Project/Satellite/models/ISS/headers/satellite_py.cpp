...
#define SWIGTYPE_p_SATELLITE swig_types[0]
...
/*-----------------------------------------------
              @(target):= _mfdff56e8d3eba163ff89f67962c185fe.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__mfdff56e8d3eba163ff89f67962c185fe

#else
#  define SWIG_init    init_mfdff56e8d3eba163ff89f67962c185fe

#endif
#define SWIG_name    "_mfdff56e8d3eba163ff89f67962c185fe"
...
SWIGINTERN PyObject *_wrap_satellite_default_data(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  SATELLITE *arg1 = (SATELLITE *) 0 ;
  PyObject * obj0 = 0 ;
  int result;
  
  if (!PyArg_ParseTuple(args,(char *)"O:satellite_default_data",&obj0)) SWIG_fail;
  {
    // SATELLITE *
    void * temp_ptr ;
  ...
  result = (int)satellite_default_data(arg1);
  {
    // INT OUT
    std::string temp_name ;
    swig_int * t = new swig_int ;
    t->value = (long long)result ;
    temp_name = "satellite_default_data" ;
    temp_name.erase(temp_name.length() - 4) ;
    //cout << "swig_int out looking for param " << temp_name << std::endl ;
    t->units = Trick::UnitsMap::units_map()->get_units(temp_name) ;
    //cout << "swig_int out found units " << t->units << std::endl ;
...
SWIGINTERN PyObject *_wrap_satellite_init(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  SATELLITE *arg1 = (SATELLITE *) 0 ;
  PyObject * obj0 = 0 ;
  int result;
  
  if (!PyArg_ParseTuple(args,(char *)"O:satellite_init",&obj0)) SWIG_fail;
  {
    // SATELLITE *
    void * temp_ptr ;
  ...
  result = (int)satellite_init(arg1);
  {
    // INT OUT
    std::string temp_name ;
    swig_int * t = new swig_int ;
    t->value = (long long)result ;
    temp_name = "satellite_init" ;
    temp_name.erase(temp_name.length() - 4) ;
    //cout << "swig_int out looking for param " << temp_name << std::endl ;
    t->units = Trick::UnitsMap::units_map()->get_units(temp_name) ;
    //cout << "swig_int out found units " << t->units << std::endl ;
...
SWIGINTERN PyObject *_wrap_satellite_shutdown(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  SATELLITE *arg1 = (SATELLITE *) 0 ;
  PyObject * obj0 = 0 ;
  int result;
  
  if (!PyArg_ParseTuple(args,(char *)"O:satellite_shutdown",&obj0)) SWIG_fail;
  {
    // SATELLITE *
    void * temp_ptr ;
  ...
  result = (int)satellite_shutdown(arg1);
  {
    // INT OUT
    std::string temp_name ;
    swig_int * t = new swig_int ;
    t->value = (long long)result ;
    temp_name = "satellite_shutdown" ;
    temp_name.erase(temp_name.length() - 4) ;
    //cout << "swig_int out looking for param " << temp_name << std::endl ;
    t->units = Trick::UnitsMap::units_map()->get_units(temp_name) ;
    //cout << "swig_int out found units " << t->units << std::endl ;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"satellite_default_data", _wrap_satellite_default_data, METH_VARARGS, NULL},
	 { (char *)"satellite_init", _wrap_satellite_init, METH_VARARGS, NULL},
	 { (char *)"satellite_shutdown", _wrap_satellite_shutdown, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
