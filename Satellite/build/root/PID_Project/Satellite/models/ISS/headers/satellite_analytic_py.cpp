...
/*-----------------------------------------------
              @(target):= _mf35f39864a9115e02690bd9f80f33b23.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__mf35f39864a9115e02690bd9f80f33b23

#else
#  define SWIG_init    init_mf35f39864a9115e02690bd9f80f33b23

#endif
#define SWIG_name    "_mf35f39864a9115e02690bd9f80f33b23"
...
SWIGINTERN PyObject *_wrap_satellite_analytic(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  SATELLITE *arg1 = (SATELLITE *) 0 ;
  PyObject * obj0 = 0 ;
  int result;
  
  if (!PyArg_ParseTuple(args,(char *)"O:satellite_analytic",&obj0)) SWIG_fail;
  {
    // SATELLITE *
    void * temp_ptr ;
  ...
  result = (int)satellite_analytic(arg1);
  {
    // INT OUT
    std::string temp_name ;
    swig_int * t = new swig_int ;
    t->value = (long long)result ;
    temp_name = "satellite_analytic" ;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"satellite_analytic", _wrap_satellite_analytic, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
